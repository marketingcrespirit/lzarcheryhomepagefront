...
import { getAllPostIds, getPostData } from "../../../lib/announces";
  ...
  return (
    <Layout titled="場內公告" bgNumber={2}>
      ...
      <article className={utilStyles.newsCard}>
        ...
        <Lastpage src="/assets/icons/white_arrow_right.png" href="/news/announces" content="上一頁"/>
        </div>
      </article>
    </Layout>
  );
